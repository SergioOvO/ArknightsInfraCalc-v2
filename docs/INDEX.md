...
| 改评分 / 排序 / 分量口径 | [SCORING_REFACTOR_PLAN.md](SCORING_REFACTOR_PLAN.md)、[SCORING_MODEL.md](SCORING_MODEL.md)；贸易社区等效换算见 [TODO/TRADE_EQUIVALENT_EFFICIENCY_ARCHITECTURE.md](TODO/TRADE_EQUIVALENT_EFFICIENCY_ARCHITECTURE.md) |
