...
| 任务 | 读这些 |
|------|--------|
| 改评分 / 排序 / 公孙公式入口 | [SCORING_REFACTOR_PLAN.md](SCORING_REFACTOR_PLAN.md)、[SCORING_MODEL.md](SCORING_MODEL.md)、[ARCHIVE/done/SCORING_PHASE3.md](ARCHIVE/done/SCORING_PHASE3.md) |
