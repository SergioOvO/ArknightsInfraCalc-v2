...
| 修复 bug 的维护者 | [维护期指南](MAINTENANCE_MODE.md) | [质量与审计](QUALITY_AND_AUDIT.md)、对应领域文档 |
| 审计体系实现的 Agent | [Agent 规则](../AGENTS.md) | [体系审计工作流](SYSTEM_AUDIT_WORKFLOW.md)、[项目地图](PROJECT_MAP.md) |
...
- [QUALITY_AND_AUDIT.md](QUALITY_AND_AUDIT.md)：跨层验证与证据体系。
